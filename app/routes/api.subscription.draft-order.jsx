...
export async function action({ request }) {
  try {
    console.log("=== SUBSCRIPTION DRAFT ORDER ENDPOINT CALLED ===");
    console.log("Request URL:", request.url);
    console.log("Request method:", request.method);
    console.log("Headers:", Object.fromEntries(request.headers.entries()));
    
    // For API calls from frontend extensions, use different authentication
    ...
    console.error("❌ Error creating subscription draft order:", error);
    return json({ 
      success: false, 
...
export async function loader({ request }) {
  console.log("GET request to subscription draft-order endpoint");
  return json({ 
    message: "Subscription Draft Order API endpoint is working", 
    method: "GET",
    url: request.url,
